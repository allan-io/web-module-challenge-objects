...
const a = createMenuItem('tacos', 11, 'lunch')
const b = createMenuItem('pizza', 5, 'lunch')
const c = createMenuItem('salad', 8, 'dinner')
console.log(a)
console.log(b)
console.log(c)
...
*/
const x = { name: "Tauro", rating: 2, feedback: "Something seemed fishy about the place if you know what i mean." }
reviews.push(x)
...
function getReviewByRating(arr, rating) {
  ...
  for (let i = 0; i < arr.length; i++) {
    if (arr[i].rating >= rating && arr[i].rating < rating + 1) newArr.push(arr[i])
  }
  return newArr
}
